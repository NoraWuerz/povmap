...
{synopt:{opt benchmark(string)}} An R vector containing the names of the indicators to be benchmarked, i,e. a value of c("Mean","Headcount") to benchmark both the mean and the headcounta. Unlike the R package, only internal benchmarking using the sample data is available. Defaults to c("Head_Count") {p_end}
